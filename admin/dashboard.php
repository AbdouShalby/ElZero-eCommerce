<?php
    ...
    if (isset($_SESSION['Username'])) {
        ...
        $latestUsers = getLatestWhere("*", "users", "GroupID", 0, "UserID",  $numUsers); // Latest Users Array

        $numItems = 6; // Number Of The Latest Items
        $latestItems = getLatest("*", "items", "Item_ID", $numItems); // Latest Items Array

        $numComments = 4; // Number Of The Latest Comments
                            ...
                            <div class="panel-body">
                                <ul class="list-unstyled latest-users">
                                    ...
                                    if (!empty($latestUsers)) {
                                        ...
                                        echo "<div class='alert custom-message'>There's No Members To Show</div>";
                                    }
                                    ?>
                                </ul>
                            </div>
                            ...
                            <div class="panel-body">
                                <ul class="list-unstyled latest-users">
                                    ...
                                    if (!empty($latestItems)) {
                                        ...
                                        echo "<div class='alert custom-message'>There's No Items To Show</div>";
                                    }
                                    ?>
                                </ul>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <?php
                                ...
                                if (!empty($comments)) {
                                    ...
                                    echo "<div class='alert custom-message'>There's No Comments To Show</div>";
                                }
                            ?>
                            </div>
                        </div>
